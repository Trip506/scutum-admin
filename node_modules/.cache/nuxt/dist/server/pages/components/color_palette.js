...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/components/color_palette.vue?vue&type=template&id=773c4528&
var render = function render() {
  ...
  return _c('div', {
    ...
    return _vm._ssrNode("<div class=\"uk-width-1-4@l uk-width-1-3@m uk-width-1-2@s\">", "</div>", [_c('ScCard', [_c('ScCardBody', [_c('h5', [_vm._v(_vm._s(color[0]))]), _vm._v(" "), color[2] ? _c('div', _vm._l(_vm.variantsAccent, function (variant, index) {
      return _c('div', {
        key: variant,
    ...
    }), 0) : _vm._e(), _vm._v(" "), !color[2] ? _c('div', _vm._l(_vm.variantsNoAccent, function (variant, index) {
      return _c('div', {
        key: variant,
        class: _vm.setClass(index, color[0], color[1], variant),
        staticStyle: {
...
// CONCATENATED MODULE: ./pages/components/color_palette.vue?vue&type=template&id=773c4528&
