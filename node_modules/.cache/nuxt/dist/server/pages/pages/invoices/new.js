...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/pages/invoices/new.vue?vue&type=template&id=751495c8&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  return _c('div', {
    ...
    return _vm._ssrNode("<div class=\"uk-flex uk-flex-middle uk-margin-medium-top sc-padding-medium-top sc-border-top\">", "</div>", [_vm._ssrNode("<div data-uk-grid class=\"uk-flex-bottom uk-grid-small uk-grid uk-flex-1\">", "</div>", [_vm._ssrNode("<div class=\"uk-width-2-5@l\">", "</div>", [_c('ScInput', {
      ...
      staticClass: "uk-label-small"
    }, [_vm._v("Amount")])])], 1)], 2), _vm._ssrNode(" <div class=\"uk-margin-left\">" + (_vm.invoice.items.length === index + 1 ? "<a href=\"javascript:void(0)\" class=\"sc-button sc-button-icon sc-button-outline sc-button-outline-square sc-button-outline-primary\"><i class=\"mdi mdi-plus\"></i></a>" : "<!---->") + " " + (_vm.invoice.items.length !== index + 1 ? "<a href=\"javascript:void(0)\" class=\"sc-button sc-button-icon sc-button-outline sc-button-outline-square sc-button-outline-danger\"><i class=\"mdi mdi-trash-can-outline\"></i></a>" : "<!---->") + "</div>")], 2);
...
// CONCATENATED MODULE: ./pages/pages/invoices/new.vue?vue&type=template&id=751495c8&
