...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./components/Offcanvas.vue?vue&type=template&id=0ac06a3b&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;

  return _vm.vxOffcanvasPresent ? _c('div', {
    attrs: {
      "id": "sc-offcanvas",
      "data-uk-offcanvas": "flip: true; container: '#nuxt-wrapper'"
    }
  }, [_vm._ssrNode("<div" + _vm._ssrClass("uk-offcanvas-bar", _vm.extraClass) + ">", "</div>", [_vm._t("default")], 2)]) : _vm._e();
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./components/Offcanvas.vue?vue&type=template&id=0ac06a3b&
...
module.exports.__inject__ = function (context) {
  add("30380914", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_task_board_vue_vue_type_style_index_0_id_b7cef2ae_prod_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(467);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_task_board_vue_vue_type_style_index_0_id_b7cef2ae_prod_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_task_board_vue_vue_type_style_index_0_id_b7cef2ae_prod_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_task_board_vue_vue_type_style_index_0_id_b7cef2ae_prod_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_task_board_vue_vue_type_style_index_0_id_b7cef2ae_prod_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/pages/task_board.vue?vue&type=template&id=b7cef2ae&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  return _c('div', {
    ...
    }, [_vm._v("\n\t\t\t\t\t\t\t\t\t" + _vm._s(task.title) + "\n\t\t\t\t\t\t\t\t")]), _vm._v(" "), task.tags.length ? _c('div', _vm._l(task.tags, function (tag) {
      return _c('span', {
        key: tag,
        staticClass: "uk-badge uk-margin-mini-right",
        class: [_vm.tagColor(tag)]
      }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t" + _vm._s(tag) + "\n\t\t\t\t\t\t\t\t\t")]);
    }), 0) : _vm._e(), _vm._v(" "), task.assignee.length ? _c('div', {
    ...
    }), _vm._v(" "), task.assignee.length > 3 ? _c('a', {
      attrs: {
        "href": "javascript:void(0)"
      }
    }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t+" + _vm._s(task.assignee.length - 3) + " more\n\t\t\t\t\t\t\t\t\t")]) : _vm._e()], 2) : _vm._e(), _vm._v(" "), task.progress ? _c('div', {
    ...
    return _c('div', {
      ...
      return _c('li', {
        ...
        staticClass: "sc-task-card-title"
      }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t\t" + _vm._s(task.title) + "\n\t\t\t\t\t\t\t\t\t\t")]), _vm._v(" "), task.tags.length ? _c('div', {
  ...
  }), 0)], 1)], 1)])], 2), _vm._ssrNode(" <div class=\"sc-fab-page-wrapper\"><a href=\"javascript:void(0)\" class=\"sc-fab sc-fab-large sc-fab-danger\"><i class=\"mdi mdi-plus\"></i></a></div> "), _vm._ssrNode("<div id=\"sc-task-modal\" data-uk-modal class=\"uk-flex-top uk-modal\">", "</div>", [_vm._ssrNode("<div class=\"uk-modal-dialog uk-modal-body uk-margin-auto-vertical\">", "</div>", [_vm._ssrNode("<button type=\"button\" data-uk-close class=\"uk-modal-close-default\"></button> "), _vm.modalData ? _vm._ssrNode("<div>", "</div>", [_vm._ssrNode("<h2 class=\"uk-modal-title\">" + _vm._ssrEscape("\n\t\t\t\t\t" + _vm._s(_vm.modalData.title) + "\n\t\t\t\t") + "</h2> " + (_vm.modalData.tags.length ? "<div class=\"uk-flex uk-flex-middle\">" + _vm._ssrList(_vm.modalData.tags, function (tag) {
    return "<span" + _vm._ssrClass("uk-badge uk-margin-mini-right", [_vm.tagColor(tag)]) + ">" + _vm._ssrEscape("\n\t\t\t\t\t\t" + _vm._s(tag) + "\n\t\t\t\t\t") + "</span>";
  }) + "</div>" : "<!---->") + " "), _vm._ssrNode("<div data-uk-grid class=\"uk-margin-medium-top\">", "</div>", [_vm._ssrNode("<div class=\"uk-flex-1\">" + (_vm.modalData.description !== '' ? "<div class=\"sc-task-modal-description\"><p>" + _vm._ssrEscape(_vm._s(_vm.modalData.description)) + "</p></div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"uk-width-1-4@m\">", "</div>", [_vm._ssrNode("<div class=\"uk-text-medium md-bg-grey-100 sc-padding-medium\">", "</div>", [_vm._ssrNode((_vm.modalData.date ? "<div><span class=\"uk-text-muted uk-margin-small-right\">\n\t\t\t\t\t\t\t\t\tdate:\n\t\t\t\t\t\t\t\t</span>" + _vm._ssrEscape(" " + _vm._s(_vm.modalData.date) + "\n\t\t\t\t\t\t\t") + "</div>" : "<!---->") + " " + (_vm.modalData.list !== '' ? "<hr class=\"uk-margin-small\">" : "<!---->") + " " + (_vm.modalData.list !== '' ? "<div><span class=\"uk-text-muted uk-margin-small-right\">\n\t\t\t\t\t\t\t\t\tin list:\n\t\t\t\t\t\t\t\t</span> <a href=\"javascript:void(0)\">" + _vm._ssrEscape("\n\t\t\t\t\t\t\t\t\t" + _vm._s(_vm.modalData.list_long) + "\n\t\t\t\t\t\t\t\t") + "</a></div>" : "<!---->") + " " + (_vm.modalData.progress ? "<hr class=\"uk-margin-small\">" : "<!---->") + " " + (_vm.modalData.progress ? "<div><span class=\"uk-text-muted\">\n\t\t\t\t\t\t\t\t\tprogress:\n\t\t\t\t\t\t\t\t</span> <div" + _vm._ssrAttr("title", _vm.modalData.progress + '%') + " class=\"uk-margin-small-top sc-progress sc-progress-small\"><div" + _vm._ssrClass("sc-progress-bar", [_vm.progressColor(_vm.modalData.progress)]) + _vm._ssrStyle(null, {
    'width': _vm.modalData.progress + '%'
  }, null) + "></div></div></div>" : "<!---->") + " " + (_vm.modalData.assignee.length ? "<hr class=\"uk-margin-small\">" : "<!---->") + " "), _vm.modalData.assignee.length ? _vm._ssrNode("<div>", "</div>", [_vm._ssrNode("<span class=\"uk-text-muted\">\n\t\t\t\t\t\t\t\t\tassignees:\n\t\t\t\t\t\t\t\t</span> "), _vm._ssrNode("<div class=\"uk-margin-small-top uk-flex uk-flex-middle\">", "</div>", _vm._l(_vm.modalData.assignee.slice(0, 3), function (assignee) {
  ...
  }), 0), _vm._ssrNode(" " + (_vm.modalData.assignee.length > 3 ? "<a href=\"javascript:void(0)\" class=\"uk-text-small uk-margin-small-top uk-display-inline-block\">" + _vm._ssrEscape("\n\t\t\t\t\t\t\t\t\t+" + _vm._s(_vm.modalData.assignee.length - 3) + " more\n\t\t\t\t\t\t\t\t") + "</a>" : "<!---->"))], 2) : _vm._e()], 2)])], 2)], 2) : _vm._e()], 2)]), _vm._ssrNode(" "), _c('client-only', [_c('div', {
...
// CONCATENATED MODULE: ./pages/pages/task_board.vue?vue&type=template&id=b7cef2ae&
...
var ColumnToggle = __webpack_require__(283);

// EXTERNAL MODULE: ./components/Offcanvas.vue + 4 modules
var Offcanvas = __webpack_require__(286);
  ...
  computed: { ...Object(external_vuex_["mapGetters"])({
    ...
    users() {
      return [{
        ...
        jsonName: 'user_1',
        text: 'carey.rice',
        avatar: __webpack_require__(123),
        avatar2x: __webpack_require__(124)
      }, {
        id: '1',
        jsonName: 'user_2',
        text: 'ian.wiza',
        avatar: __webpack_require__(41),
        avatar2x: __webpack_require__(127)
      }, {
        id: '2',
        jsonName: 'user_3',
        text: 'telly07',
        avatar: __webpack_require__(39),
        avatar2x: __webpack_require__(130)
      }];
    },
