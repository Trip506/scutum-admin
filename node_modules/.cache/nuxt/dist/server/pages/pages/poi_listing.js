...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/pages/poi_listing.vue?vue&type=template&id=1fd3358c&
var render = function render() {
  ...
  return _c('div', {
    ...
    }) + ">" + (poi.main ? "<span class=\"sc-text-semibold md-color-red-600\">" + _vm._ssrEscape("\n\t\t\t\t\t\t\t" + _vm._s(poi.title) + "\n\t\t\t\t\t\t") + "</span>" : "<p" + _vm._ssrAttr("title", poi.title) + " class=\"sc-text-semibold uk-margin-remove uk-text-truncate\">" + _vm._ssrEscape("\n\t\t\t\t\t\t\t" + _vm._s(poi.title) + "\n\t\t\t\t\t\t") + "</p>") + " <p" + _vm._ssrAttr("title", poi.address) + " class=\"sc-color-secondary uk-text-truncate uk-margin-remove\">" + _vm._ssrEscape("\n\t\t\t\t\t\t\t" + _vm._s(poi.address) + "\n\t\t\t\t\t\t") + "</p></li>";
  ...
  }), _vm._v(" "), _vm.isWindowOpen ? _c('InfoWindow', {
    attrs: {
  ...
  }) : _vm._e()], 2)], 1)], 1)], 2), _vm._ssrNode(" "), _c('client-only', [_c('ScOffcanvas', {
    ref: "offcanvas"
  }, [_c('ul', {
...
// CONCATENATED MODULE: ./pages/pages/poi_listing.vue?vue&type=template&id=1fd3358c&
...
/* harmony default export */ var poi_listingvue_type_script_lang_js_ = ({
  ...
  data: () => ({
    ...
    markersConfig: {
      icon: __webpack_require__(541),
      iconMain: __webpack_require__(440)
    },
    poiList: [{
      id: 0,
      title: "Rome",
